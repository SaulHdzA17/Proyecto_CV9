 ...
 * @author jauregui
 */
public class VentanaBuscarEventos extends javax.swing.JPanel {

    /**
     * Creates new form VentanaBuscarPersonal
     */
    public VentanaBuscarEventos() {
        initComponents();
    }
    ...
    @SuppressWarnings("unchecked")
        ...
        String sql="select id from EventosMuseo";
        Statement st;
      ...
      public void BuscarNombre(String tabla){
        String sql="select Nombre_Evento from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarDescripcion(String tabla){
        String sql="select Descripcion from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarFechaInicio(String tabla){
        String sql="select Fecha_Inicio from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
       ...
       JOptionPane.showMessageDialog(null, "Error" + e.toString());
        ...
        public void BuscarFechaFin(String tabla){
        String sql="select Fecha_Fin from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarHoraInicio(String tabla){
        String sql="select Hora_Inicio from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarHoraFin(String tabla){
        String sql="select Hora_Fin from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
       ...
       public void BuscarLugar(String tabla){
        String sql="select Lugar from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
       ...
       public void BuscarCupo(String tabla){
        String sql="select Cupo_Maximo from EventosMuseo";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
    ...
    RegistrarEventos p= new RegistrarEventos();
    ...
    private void initComponents() {
        ...
        BotonFiltroCURP.setText("Descripción");
        ...
        BotonFiltroRFC.setText("Fecha Inicio");
        ...
        jRadioButton2.setText(" Fecha Fin");
    ...
    private void BotonFiltroCURPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonFiltroCURPActionPerformed
        // TODO add your handling code here:
        BuscarDescripcion("EventosMuseo");
    ...
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        // TODO add your handling code here:
        BuscarHoraInicio("EventosMuseo");
    }//GEN-LAST:event_jRadioButton3ActionPerformed

    private void jRadioButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton4ActionPerformed
        // TODO add your handling code here:
        BuscarHoraFin("EventosMuseo");
    }//GEN-LAST:event_jRadioButton4ActionPerformed

    private void jRadioButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton5ActionPerformed
        // TODO add your handling code here:
        BuscarLugar("EventosMuseo");
    }//GEN-LAST:event_jRadioButton5ActionPerformed

    private void jRadioButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton6ActionPerformed
        // TODO add your handling code here:
        BuscarCupo("EventosMuseo");
