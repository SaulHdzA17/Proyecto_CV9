 ...
 * @author jauregui
 */
public class VentanaBuscarBitacora extends javax.swing.JPanel {

    /**
     * Creates new form VentanaBuscarPersonal
     */
    public VentanaBuscarBitacora() {
        initComponents();
    }
    ...
    @SuppressWarnings("unchecked")
        ...
        String sql="select id from Bitacora";
        Statement st;
      ...
      public void BuscarAsunto(String tabla){
        String sql="select asunto from Bitacora";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarDescripcion(String tabla){
        String sql="select descripcion_incidente from Bitacora";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
      ...
      public void BuscarFecha(String tabla){
        String sql="select fecha_incidente from Bitacora";
        Statement st;
        Conexion con = new Conexion();
        Connection conexion = con.estableceConexion();
       System.out.println(sql);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Bitácora");
        ...
        BotonFiltroRFC.setText("Fecha Incidente");
